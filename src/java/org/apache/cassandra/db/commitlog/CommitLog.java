...
public class CommitLog implements CommitLogMBean
{
    ...
    CommitLog(String location, CommitLogArchiver archiver)
    {
        ...
        metrics = new CommitLogMetrics();//wxc pro 2015-9-27:22:13:03 这个Metrics能不能用到现在自己的工程中去？ 怎么用？有什么好处可以说动决策者？

        executor = DatabaseDescriptor.getCommitLogSync() == Config.CommitLogSync.batch
                ? new BatchCommitLogService(this)
                : new PeriodicCommitLogService(this); //wxc 2015-9-27:22:15:25 批量和定期并不对等吧？
    ...
    public ReplayPosition add(Mutation mutation)
    {
        ...
        Allocation alloc = allocator.allocate(mutation, (int) totalSize);//wxc pro 2015-8-19:13:13:43 ������C��������Allocation��
     ...
     */
    //wxc 2015-8-16:21:33:03 commitLog�����Լ����̡߳� ������ʲô��
